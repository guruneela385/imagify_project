...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >Unleash your creativity with AI.Turn your imagination into visual art in seconds - just type,and watch the magin happen ..</motion.p>
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                ...
                // to show the alternative images
                <motion.img
